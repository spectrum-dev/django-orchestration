...
from .marketsim import run as run_marketsim
...
def run(input: dict, output: dict) -> dict:
    ...
    # )
    # TODO: Alter the interface of the dict
    input = {}
    # selectable_data = {
    ...
    # TODO: Alter the interface of the function to select the signal block data
    block_data = {}
