...
SINGLE_FULL_FLOW_VALID = {
    "nodeList": {
        "1": {
            "blockType": "DATA_BLOCK",
            "blockId": 1,
            "equity_name": {"options": ["AAPL"], "value": "AAPL"},
            "data_type": {
                "options": ["intraday", "daily_adjusted"],
                "value": "intraday",
            },
            "interval": {"options": ["1min"], "value": "1min"},
            "outputsize": {"options": ["compact", "full"], "value": "compact"},
            "start_date": {"value": "2020-01-01"},
            "end_date": {"value": "2021-01-01"},
        },
        "2": {
            "blockType": "COMPUTATIONAL_BLOCK",
            "blockId": 1,
        ...
        "4": {
            "blockType": "SIGNAL_BLOCK",
            "blockId": 1,
            "event_type": {"options": ["INTERSECT"], "value": "INTERSECT"},
            "event_action": {"options": ["BUY", "SELL"], "value": "BUY"},
        },
        "5": {
            ...
            "stop_loss": {"value": "0.00"},
            "take_profit": {"value": "0.00"},
            "trade_amount_value": {"value": "1000.00"},
        },
    },
    "edgeList": [
        {
