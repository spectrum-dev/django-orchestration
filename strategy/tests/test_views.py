...
class GetAllStrategiesViewTest(TestCase):
    ...
    def test_ok(self):
        ...
        self.assertDictEqual(
            response.json(),
            {'strategies': [{'strategy_id': '00000000-0000-0000-0000-000000000025', 'strategy_name': 'Strategy 1', 'created_at': '2012-11-01T08:16:13Z'}, {'strategy_id': '00000000-0000-0000-0000-000000000028', 'strategy_name': 'Strategy 2', 'created_at': '2012-11-01T08:16:13Z'}]},
        )
...
class CommitIdViewTest(TestCase):
    ...
    def test_ok(self):
        ...
        self.assertDictEqual(
            response.json(),
            {'strategyId': '5f4a0050-6766-40e1-946c-ddbd5533a3d1', 'commitId': '00000000-0000-0000-0000-00000000001a'}
        )
