    ...
    def test_debug(self):
        node_list = {
            1: {
                ...
                "start_date": {
                    "value": "2021-08-26",
                    "rawValue": "2021-09-26T22:58:13.000Z",
                },
                "end_date": {
                    "value": "2021-10-05",
                    "rawValue": "2021-10-05T22:58:13.842Z",
                },
            ...
            2: {
                ...
                "incoming_data": {"value": "close"},
                "lookback_period": {"value": "3"},
            },
            3: {
                "blockType": "SIGNAL_BLOCK",
                "blockId": 2,
                "incoming_data": {"inputFromConnectionValue": "", "value": "data"},
                "saddle_type": {"options": [], "value": "UPWARD"},
                "event_action": {"options": [], "value": "BUY"},
                "consecutive_up": {"value": "1"},
                "consecutive_down": {"value": "1"},
            },
        }
        edge_list = [
            {
